...
{
    QString fileName = QFileDialog::getOpenFileName (this,QObject::tr("文件对话框"),"D: ",QObject::tr("图片文件(*png *jpg);;文本文件(*txt)"));
...
void MyWidget::on_pushButton_4_clicked()
{
    ...
    items<<tr("条目1")<<tr("条目2");
    //获取下拉框
    QString item = QInputDialog::getItem (this,tr("输入浮点数对话框"),tr("请选择或输入一个条目"),items,0,true,&ok);
    if(ok)
        qDebug()<<"item:"<<item;
...
void MyWidget::on_pushButton_5_clicked()
{
    ...
    if(ret1 == QMessageBox::Yes)
        qDebug()<<tr("问题!");
    //提示对话框
    int ret2 = QMessageBox::information (this,tr("提示对话框"),tr("只是Qt书籍!"),QMessageBox::Ok);
